...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "front", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=False
        ),
        sa.Column(
            "back", sqlmodel.sql.sqltypes.AutoString(length=1000), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_flashcard_deck_id"), "flashcard", ["deck_id"], unique=False
    )
    op.create_table(
        "saveddeck",
        sa.Column("user_id", sa.Integer(), nullable=False),
