...
def CRUD_get_user(session: Session, user_id: int) -> User:
...
def CRUD_update_user(session: Session, user_id: int, new_email: Optional[str] = None, new_username: Optional[str] = None, new_password: Optional[str] = None) -> User:
